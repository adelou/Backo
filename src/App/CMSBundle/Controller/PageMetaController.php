...
class PageMetaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppCMSBundle:PageMeta')->findAll();
     ...
     *
     * @Route("/", name="pagemeta_create")
     * @Method("POST")
     * @Template("AppCMSBundle:PageMeta:new.html.twig")
     */
    ...
    private function createCreateForm(PageMeta $entity)
    {
        $form = $this->createForm(new PageMetaType(), $entity, array(
            'action' => $this->generateUrl('pagemeta_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppCMSBundle:PageMeta')->find($id);
     ...
     *
     * @Route("/{id}/edit", name="pagemeta_edit")
     * @Method("GET")
     * @Template()
     */
    ...
    */
    ...
    {
        $form = $this->createForm(new PageMetaType(), $entity, array(
            'action' => $this->generateUrl('pagemeta_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     *
     * @Route("/{id}", name="pagemeta_update")
     * @Method("PUT")
     * @Template("AppCMSBundle:PageMeta:edit.html.twig")
     */
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('pagemeta_delete', array('id' => $id)))
            ->setMethod('DELETE')
