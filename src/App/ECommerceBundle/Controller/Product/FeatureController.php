...
use App\ECommerceBundle\Entity\Product\Feature;
use App\ECommerceBundle\Form\Type\Product\FeatureType;
...
class FeatureController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppECommerceBundle\Product:Feature')->findAll();
     ...
     * @Method("POST")
     * @Template("AppECommerceBundle\Product:Feature:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppECommerceBundle\Product:Feature')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AppECommerceBundle\Product:Feature:edit.html.twig")
     */
