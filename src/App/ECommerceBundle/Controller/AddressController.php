...
class AddressController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppECommerceBundle:Address')->findAll();
     ...
     * @Method("POST")
     * @Template("AppECommerceBundle:Address:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppECommerceBundle:Address')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AppECommerceBundle:Address:edit.html.twig")
     */
