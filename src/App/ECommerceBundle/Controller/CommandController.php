...
class CommandController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppECommerceBundle:Command')->findAll();
     ...
     * @Method("POST")
     * @Template("AppECommerceBundle:Command:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppECommerceBundle:Command')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AppECommerceBundle:Command:edit.html.twig")
     */
